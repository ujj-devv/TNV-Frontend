    ...
    <>
      <div className="text-center mb-8 p-8 md:px-32 md:py-16 bg-[#F3FAF8]">
        <Layout>
          ...
          <p className="text-[#9EA0A0] font-normal text-base mb-20">
      ...
      <Layout>
        <div className="flex flex-col md:flex-row gap-12 md:px-32 py-8">
          {activeButton === 1
            ? applicationPricing.map(
                ({ key, duration, price, total, features }) => (
                  <PricingCard
                    key={key}
                    duration={duration}
                    price={price}
